...
done_processing:
  ...
  memif.read(0x80000000, mem_size, (void *)top->rootp->ariane_testharness__DOT__i_sram__DOT__gen_cut__BRA__0__KET____DOT__i_tc_sram_wrapper__DOT__i_ram__DOT__Mem_DP.m_storage);
#else
  // Verilator v4
